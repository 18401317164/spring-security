...
public class JwtUtil {
    ...
    public static void main(String[] args) throws Exception {
        String jwt = createJWT("123333");
        System.out.println(jwt);
        Claims claims = parseJWT("eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIzYjM5NGQ3YTYwYTM0YzMyODkyM2I1YTY4MmY5NTRkZCIsInN1YiI6IjEyMzMzMyIsImlzcyI6ImhoenoiLCJpYXQiOjE2NTgwNTY3NTcsImV4cCI6MTY1ODA2MDM1N30.oAyd_hGHO8AthQd9R9COHV1cmWlvmIUWSeY_9DR44Lk");
